# coding: utf-8
"""
Django settings for django_buchettes project.
...
SECRET_KEY = '2b_6hq)-^b5&@uhv#2qeg(3w+jpj(m=_g4&&0$t#^e^3!3&-17'
...
ROOT_URLCONF = 'django_buchettes.urls'
...
WSGI_APPLICATION = 'django_buchettes.wsgi.application'
